...
from mindspore import context, save_checkpoint, set_device
...
def trainer(args):
    ...
    set_device(device_target=args.device_target, device_id=args.device_id)
    if args.run_distribute:
        if args.device_target == 'GPU':
            if os.getenv('DEVICE_ID'):
                device_id = int(os.getenv('DEVICE_ID'))
                set_device(device_target=args.device_target, device_id=device_id)
